...
var dataTests = []Test{
	{
		...
		map[string]interface{}{"hello": func(options *mario.Options) string {
	...
	},
	{
		...
		map[string]interface{}{"hello": "hello"},
		map[string]interface{}{"let": func(options *mario.Options) string {
	...
	},
	{
		...
		map[string]interface{}{"adjective": "happy"},
		map[string]interface{}{"hello": func(context string, options *mario.Options) string {
			str := "error"
	...
	},
	{
		...
		map[string]interface{}{
			"hello": func(options *mario.Options) string {
				return options.Fn()
			},
			"world": func(options *mario.Options) string {
				str := "error"
				if b, ok := options.Value("exclaim").(bool); ok {
					if b {
						str = "!"
	...
	},
	{
		...
		map[string]interface{}{
			...
			"world": func(context string, options *mario.Options) string {
	...
	},
	{
		...
		map[string]interface{}{
			"helper": func(options *mario.Options) string {
				data := options.NewDataFrame()
