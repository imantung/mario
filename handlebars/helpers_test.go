...
func linkHelper(prefix string, options *mario.Options) string {
	return fmt.Sprintf(`<a href="%s/%s">%s</a>`, prefix, options.ValueStr("url"), options.ValueStr("text"))
}

func rawHelper(options *mario.Options) string {
	return options.Fn()
}

func rawThreeHelper(a, b, c string, options *mario.Options) string {
	return options.Fn() + a + b + c
}

func formHelper(options *mario.Options) string {
	return "<form>" + options.Fn() + "</form>"
}

func formCtxHelper(context interface{}, options *mario.Options) string {
	return "<form>" + options.FnWith(context) + "</form>"
}

func listHelper(context interface{}, options *mario.Options) string {
...
func detectDataHelper(options *mario.Options) string {
...
var helpersTests = []Test{
	...
	},
	{
		...
		nil,
		map[string]interface{}{"goodbyes": func(options *mario.Options) string {
			out := ""
	...
	},
	{
		...
		nil,
		map[string]interface{}{"link": func(options *mario.Options) string {
	...
	},
	{
		...
		map[string]string{"cruel": "cruel", "world": "world"},
		nil,
		map[string]interface{}{"goodbye": func(cruel, world string, options *mario.Options) string {
...

	{
		...
		nil, nil,
		map[string]interface{}{"goodbye": func(options *mario.Options) string {
...

	{
		...
		nil,
		map[string]interface{}{
			"goodbye": func(options *mario.Options) string {
