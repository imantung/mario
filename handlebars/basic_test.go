...
var basicTests = []Test{
	...
	},
	{
		...
		"{{awesome}}",
		map[string]interface{}{"awesome": func() mario.SafeString { return mario.SafeString("&'\\<>") }},
		nil, nil, nil,
		"&'\\<>",
	},
	{
	...
	},
	{
		"functions (2)",
		"{{awesome}}",
		map[string]interface{}{"awesome": func(options *mario.Options) string {
	...
	},
	{
		...
		map[string]interface{}{"awesome": func(context interface{}, options *mario.Options) string {
	...
	},
	{
		...
		map[string]interface{}{
			"awesome": func(context interface{}, options *mario.Options) string {
				return options.FnWith(context)
			},
			"value": true,
		},
	...
	},
	{
		...
		map[string]interface{}{
			"awesome": func(options *mario.Options) string {
				return options.Fn()
			},
		},
		nil, nil, nil,
	...
	// 		"foo": {
	// 			"awesome": func(options *mario.Options) interface{} {
	// 				return options.Ctx()
	// 			},
	// 		},
	// 	},
